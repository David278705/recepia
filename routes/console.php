...
Schedule::command('pilo:cobrar-suscripciones')->hourly();

// Recordatorios de renovación por correo: una vez al día, a media mañana
// hora de Colombia.
Schedule::command('pilo:recordatorios-suscripcion')->dailyAt('13:00'); // 8:00 am America/Bogota (servidor en UTC)

// Salud de las conexiones de WhatsApp: detecta coexistencias caídas (dueño
// sin abrir su app ~2 semanas) y alerta al super_admin.
Schedule::command('pilo:verificar-conexiones')->dailyAt('11:00'); // 6:00 am America/Bogota
